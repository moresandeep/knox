...
public class RedirectHandler extends ScopedHandler {
    ...
    public RedirectHandler(final GatewayConfig config, final Topology topology, final GatewayServices services) {
        super();
    ...
    public void doHandle(final String target, final Request baseRequest, final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        RedirectHandler.ForwardedRequest newRequest = new RedirectHandler.ForwardedRequest(request, uri);
        LOG.redirectHandlerForward(target, newTarget);
    ...
    static class ForwardedRequest extends HttpServletRequestWrapper {
        ...
        public ForwardedRequest( final HttpServletRequest request, final String newURL ) {
            super( request );
            this.newURL = newURL;
        }
