...
public class RedirectHandlerNew extends ScopedHandler {
    ...
    public RedirectHandlerNew(final GatewayConfig config, final Topology topology, final GatewayServices services) {
        super();
